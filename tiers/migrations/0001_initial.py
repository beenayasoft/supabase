...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="Liste des flags: prospect, client, fournisseur, etc.",
                    ),
                ),
                (
                    "is_deleted",
        ...
        migrations.AddIndex(
            model_name="tiers",
            index=models.Index(
                fields=["assigned_user"], name="tiers_tiers_assigne_57d6d4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="tiers",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["tier", "date"], name="tiers_activ_tier_id_0db207_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activitetiers",
        ...
        migrations.AddIndex(
            model_name="activitetiers",
            index=models.Index(
                fields=["utilisateur"], name="tiers_activ_utilisa_82bedf_idx"
            ),
        ),
    ]
